...
tf.app.flags.DEFINE_string('source_dir', 'babi/', 'Directory containing bAbI sources.')
tf.app.flags.DEFINE_string('dest_dir', 'babi/processed/', 'Where to write datasets.')
...
def main():
    ...
    tar = tarfile.open(os.path.join(FLAGS.source_dir, 'babi_tasks_data_1-20_v1-2.tar.gz'))
